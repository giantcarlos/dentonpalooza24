  ...
  render() {
    ...
    return (
      <section className="shop-grid">
        <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ amount: .75, once: true }} id="tickets" className="tickets">
        ...
        <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ amount: .75, once: true }} id="merch" className="merch">
        ...
        <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ amount: .75, once: true }} className="beneficiaries">
