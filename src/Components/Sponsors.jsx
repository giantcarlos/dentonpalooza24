  ...
  render() {
    ...
    return (
        <motion.div variants={container} initial="hidden" animate="show" className="image-grid">
            ...
            <motion.a variants={item} href='https://danssilverleaf.com/' target="_blank"><img src={"https://i.imgur.com/jHoY46F.png"} alt='logo of Dans Silverleaf' /></motion.a>
            <motion.a variants={item} href='https://www.eastsidedtx.com/' className='image-reverse' target="_blank"><img src={"https://i.imgur.com/CWrmgQg.jpg"} alt='logo of Eastside' /></motion.a>
            ...
            <motion.a variants={item} href='https://oakstreetdrafthouse.com/' className='image-reverse' target="_blank"><img src={"https://i.imgur.com/L1Jf7L6.png"} alt='logo of Oak Street Drafthouse' /></motion.a>
