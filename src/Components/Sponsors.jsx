  ...
  render() {
    ...
    return (
        <motion.div variants={container} initial="hidden" animate="show" className="image-grid">
            ...
            <motion.a variants={item} href='https://rubberglovesdenton.com/' className='image-reverse-gray' target="_blank"><img src={"https://i.imgur.com/6ZhmD7H.png"} alt='logo of Rubber Gloves' /></motion.a>
            ...
            <motion.div variants={item} className="message">A big thanks to our sponsors!</motion.div>
        </motion.div>
    )
  }
}
