  ...
  if (!isMobile) {
    ...
    return (
      <section id="lineup" className="lineup">
        ...
        <motion.img variants={variants} initial="start" whileInView="end" transition={{duration: .375}} viewport={{ once: true }} className="poster" src='https://i.imgur.com/s993AaR.jpeg' alt='Lineup poster for Dentonpalooza 4'></motion.img>
