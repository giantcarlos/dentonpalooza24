  ...
  render() {
    return (
      <section id="lineup" className="lineup">
        ...
        <motion.img initial={{ y: 200 }} whileInView={{ y: 0 }} transition={{ duration: 1 }} viewport={{ margin: "100px", once: true }} className="poster" src='https://i.imgur.com/s993AaR.jpeg' alt='Lineup poster for Dentonpalooza 4'></motion.img>
