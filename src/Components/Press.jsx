    ...
    return (
      <section id="press" className="press">
        ...
        <div className="press-grid">
            <motion.a initial={{ y: 250 }} whileInView={{ y: 0 }} transition={{ duration: .375 }} viewport={{ once: true }} className="press-card" href="https://dentonrc.com/entertainment/dentonpalooza-4-books-dentons-mad-max-truck-invites-mayor-to-sing-nu-metal-onstage-and/article_3f17c2a2-2c1d-11ef-9010-f3ac1b7b25c4.html" target="_blank">
            ...
            <motion.a initial={{ y: 250 }} whileInView={{ y: 0 }} transition={{ duration: .375 }} viewport={{ once: true }} className="press-card" href="https://www.dallasobserver.com/music/denton-festival-dentonpalooza-is-back-with-more-quirkiness-19644739" target="_blank">
                <div className="press-image">
