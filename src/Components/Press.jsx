    ...
    return (
      <section id="press" className="press">
        ...
        <div className="press-grid">
            ...
            <motion.a initial={{ opacity: 0, y: 250 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: .375 }} viewport={{ margin: "75px", once: true }} className="press-card" href="https://www.dallasobserver.com/music/denton-festival-dentonpalooza-is-back-with-more-quirkiness-19644739" target="_blank">
                <div className="press-image">
